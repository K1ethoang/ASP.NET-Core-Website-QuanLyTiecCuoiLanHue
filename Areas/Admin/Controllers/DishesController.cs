...
namespace ASP.NET_Core_Website_QuanLyTiecCuoiLanHue.Areas.Admin.Controllers
{
    ...
    public class DishesController : Controller
    {
        ...
        {
            ViewData["DishTypeId"] = new SelectList(_context.DishTypes, "DishTypeId", "DishTypeId");
        ...
        public async Task<IActionResult> Create([Bind("DishId,DishName,Price,DishTypeId,UnitId")] Dish dish)
        {
